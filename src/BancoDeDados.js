export const projects = {
    relogio: {
        ...
        imgNote: './src/assets/Elementos/note-relogio.png',
        imgCel: './src/assets/Elementos/cel-relogio.png',
        tech:{
            html: true,
            css: true,
            js: true,
    ...
    projeto2: {
        ...
        imgNote: './src/assets/Elementos/note-login2.png',
        imgCel: './src/assets/Elementos/cel-login2.png',
        tech:{
            html: true,
            css: true,
            js: true,
    ...
    projeto3: {
        ...
        imgNote: './src/assets/Elementos/note-login1.png',
        imgCel: './src/assets/Elementos/cel-login1.png',
        tech:{
            html: true,
            css: true,
            js: true,
    ...
    projeto5: {
        ...
        imgNote: './src/assets/Elementos/note-portfolio.png',
        imgCel: './src/assets/Elementos/cel-portfolio.png',
        tech:{
            html: true,
            css: true,
            js: true,
    ...
    projeto6: {
        ...
        imgNote: './src/assets/Elementos/note-vv.png',
        imgCel: './src/assets/Elementos/cel-vv.png',
        tech:{
            html: true,
            css: true,
            js: true,
